...
const LINKS = [
  { href: "/csa", label: "Queue", exact: true },
  { href: "/csa/applications/new", label: "New application" },
];

export function CsaNav() {
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold uppercase tracking-wide text-role-csa">
                CSA intake
              </p>
            </div>
          </div>
              ...
              return (
                <Link
                  ...
                  className={`rounded-sm px-3 py-2 text-[13px] transition-colors ${
                    active
                      ? "bg-role-csa/10 font-semibold text-role-csa"
