...
const LINKS = [{ href: "/remedial", label: "Turned-over accounts", exact: true }];

export function RemedialNav() {
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold uppercase tracking-wide text-role-remedial">
                Remedial
              </p>
            </div>
          </div>
              ...
              return (
                <Link
                  ...
                  className={`rounded-sm px-3 py-2 text-[13px] transition-colors ${
                    active
                      ? "bg-role-remedial/10 font-semibold text-role-remedial"
