...
const LINKS = [{ href: "/collector", label: "Assigned accounts", exact: true }];
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold uppercase tracking-wide text-role-collector">
                Collection
              </p>
            </div>
          </div>
              ...
              return (
                <Link
                  ...
                  className={`rounded-sm px-3 py-2 text-[13px] transition-colors ${
                    active
                      ? "bg-role-collector/10 font-semibold text-role-collector"
