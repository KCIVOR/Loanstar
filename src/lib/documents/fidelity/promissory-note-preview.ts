...
<p>For value received, I/We, <b><u>{{borrowerName}},</u></b> of legal age and residing at <b><u>{{address}},</u></b> promise to pay <b><u>{{companyName}} (LSLGC for brevity)</u></b>, or ORDER the sum of <b><u>{{principalAndCentavosInWords}} (Php {{principal}}),</u></b> Philippine currency, and I/We have accepted the Terms and Conditions of this Promissory Note (&ldquo;NOTE&rdquo; for brevity) to pay the loan. Furthermore, I/We promise, jointly and severally, to pay this loan in <b><u>{{termsInWords}}</u></b> months in the amount of <b><u>{{monthlyAmortizationAndCentavosInWords}} (Php {{monthlyAmortization}})</u></b> per month starting on <b><u>{{firstPaymentDate}}</u></b> with a monthly interest of <b><u>{{interestRateInWords}}</u></b> and the succeeding monthly installments on the <u>{{installmentDayOrdinal}}</u> day of every month thereafter until the obligation is fully paid, without need of any further notice, demand, act or deed on the part of LSLGC.</p>
...
<p>5. In case of pre-payment of this Note, I/We agree to pay penalty equivalent to one month interest or <b><u>{{interestRateInWords}}</u></b> of the principal amount to be paid under this Note, except when not allowed under R.A. No. 7394 otherwise known as the &ldquo;The Consumer Act of the Philippines&rdquo;.</p>
...
<td>____________________________<br><b><u>{{borrowerName}}</u></b><br>Signature Over Borrower's Name<br>Address: {{address}}<br>ID. No. TIN {{borrowerTin}}<br>Issued on: {{borrowerIdIssuedOn}}</td>
