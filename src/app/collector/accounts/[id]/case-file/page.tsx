...
export default function CollectorCaseFilePage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(body?.error ?? "Failed to load case file");
      }
  ...
  const borrowerName = packet?.borrower.name?.trim() || "Case file";
