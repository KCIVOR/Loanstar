-- Meridian-branded transactional email shells (deny / approve / test)
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="vertical-align:middle;padding-right:12px;">
                  <img src="https://acopcwlhkovssjnrqygk.supabase.co/storage/v1/object/public/branding/logo.png?v=3" alt="LoanStar" width="36" height="36" style="display:block;border:0;outline:none;width:36px;height:36px;border-radius:8px;background:#FFFFFF;" />
                </td>
                <td style="vertical-align:middle;font-family:Sora, 'Public Sans', 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;font-size:20px;font-weight:700;letter-spacing:-0.02em;color:#FFFFFF;">
                  LoanStar
                </td>
              </tr>
            </table>
