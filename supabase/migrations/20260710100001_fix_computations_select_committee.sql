-- Committee workspace shows the full computation panel per client spec
-- ("committee has full access to the computation sheet"), but computations_select
-- never granted the committee module view — the panel silently rendered null.
